...
class ArtistoHomeScreen extends StatefulWidget {
  const ArtistoHomeScreen({Key? key}) : super(key: key);
  @override
  State<ArtistoHomeScreen> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<ArtistoHomeScreen> {
      ...
      bottomNavigationBar: CurvedNavigationBar(
        ...
        onTap: (index) {
          ...
          if (index == 0) {
            ...
            // open Artists List screen
            Get.to(() => PublisherList());
          } else if (index == 3) {
            // open loged in user profile and home
...
// if postprice was 0 so write it is free and show for all users
    ...
    return Container(
      ...
      // make card and design for posts
      child: Card(
        elevation: 5,
