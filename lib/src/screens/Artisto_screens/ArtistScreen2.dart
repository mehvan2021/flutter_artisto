...
class PublisherBio2 extends StatelessWidget {
  PublisherBio2({
    Key? key,
    required this.Userinf,
  }) : super(key: key);

  final ArtistooUser Userinf;
  ...
  Widget build(BuildContext context) {
    String UserPhone = Userinf.phone.toString();
              ...
              Expanded(
                child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                    stream: FirebaseFirestore.instance
                        .collection('posts')
                        .where('user.name', isEqualTo: Userinf.name)
                        .snapshots(),
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Flexible(
                                          ...
                                          child: Column(
                                            children: [
                                              new Text(Userinf.name),
                                              new Text(Userinf.email),
                                              new Text(
                                                  Userinf.phone.toString()),
                                            ],
                                          ),
                                        ))
                                      ],
